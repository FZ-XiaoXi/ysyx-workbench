...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 100 ????? 11000 11", blt    , B, s->dnpc = ((signed)src1<(signed)src2) ? (s->pc + imm):(s->snpc));
  INSTPAT("??????? ????? ????? 101 ????? 11000 11", bge    , B, s->dnpc = ((signed)src1>=(signed)src2) ? (s->pc + imm):(s->snpc));
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl    , R, R(rd) = (unsigned)src1 >> (src2 & 0x3f));
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , R, R(rd) = (signed)src1 >> (src2 & 0x3f));
