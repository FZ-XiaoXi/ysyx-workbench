...
module top(
  ...
  wire S_wlast;
  wire [3:0] S_bid;
  wire [3:0] S_arid;  wire [7:0] S_arlen;  wire [2:0] S_arsize;  wire [1:0] S_arburst;
  wire S_rlast;
  wire [3:0] S_rid;
  bridge XBAR_Bridge_inst(
    ...
    .MEM_arid(RAM_arid),      .MEM_arlen(RAM_arlen),      .MEM_arsize(RAM_arsize),    .MEM_arburst(RAM_arburst),
    ...
    .UART_arid(UART_arid),      .UART_arlen(UART_arlen),      .UART_arsize(UART_arsize),    .UART_arburst(UART_arburst),
    ...
    .CLINT_arid(CLINT_arid),      .CLINT_arlen(CLINT_arlen),      .CLINT_arsize(CLINT_arsize),    .CLINT_arburst(CLINT_arburst),
  ...
  wire RAM_wlast;
  wire [3:0] RAM_bid;
  wire [3:0] RAM_arid;  wire [7:0] RAM_arlen;  wire [2:0] RAM_arsize;  wire [1:0] RAM_arburst;
  wire RAM_rlast;
  wire [3:0] RAM_rid;
  MEM RAM(
    .clk(clk),
  ...
  wire UART_wlast;
  wire [3:0] UART_bid;
  wire [3:0] UART_arid;  wire [7:0] UART_arlen;  wire [2:0] UART_arsize;  wire [1:0] UART_arburst;
  wire UART_rlast;
  wire [3:0] UART_rid;
  UART UART_inst(
    .clk(clk),
  ...
  wire CLINT_wlast;
  wire [3:0] CLINT_bid;
  wire [3:0] CLINT_arid;  wire [7:0] CLINT_arlen;  wire [2:0] CLINT_arsize;  wire [1:0] CLINT_arburst;
  wire CLINT_rlast;
  wire [3:0] CLINT_rid;
  CLINT CLINT_inst(
    .clk(clk),
