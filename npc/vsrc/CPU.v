...
`ifdef USE_VERILATOR
	...
	always @(posedge clock) begin
		...
		tb_FINAL_npc<=(wbu_in_bus_exception[4])?((wbu_out_bus_exception[3:0]==`ysyx_26010011_EXCEPTION_MRET)?csr_mepc:csr_mtvec):((wbu_in_bus_isJUMP | (wbu_in_bus_isBRANCH&wbu_in_bus_comp_result)) ? wbu_in_bus_gpr_wdat : wbu_in_bus_pc + 32'd4);//TODO MTVEC
