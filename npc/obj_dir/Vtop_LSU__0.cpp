...
extern const VlUnpacked<CData/*1:0*/, 32> Vtop__ConstPool__TABLE_h64aee117_0;
extern const VlUnpacked<CData/*0:0*/, 32> Vtop__ConstPool__TABLE_hd67e0a11_0;
extern const VlUnpacked<CData/*1:0*/, 32> Vtop__ConstPool__TABLE_hefaadead_0;
...
void Vtop_LSU___ico_sequent__TOP__top__LSU_0__0(Vtop_LSU* vlSelf) {
    ...
    __Vtableidx1 = 0;
    // Body
    __Vtableidx1 = (((IData)(vlSelfRef.__PVT__lsu_respValid) 
                     << 4U) | (((IData)(vlSelfRef.__PVT__lsu_reqReady) 
                                << 3U) | (((IData)(vlSymsp->TOP__top__IDU_0.__PVT__lsu_reqEN) 
                                           << 2U) | (IData)(vlSelfRef.state))));
    if ((1U & Vtop__ConstPool__TABLE_h64aee117_0[__Vtableidx1])) {
        vlSelfRef.__PVT__lsu_reqValid = Vtop__ConstPool__TABLE_hd67e0a11_0
            [__Vtableidx1];
    }
    if ((2U & Vtop__ConstPool__TABLE_h64aee117_0[__Vtableidx1])) {
        vlSelfRef.__PVT__next_state = Vtop__ConstPool__TABLE_hefaadead_0
            [__Vtableidx1];
    }
    ...
    vlSelfRef.RAM_0__DOT____Vcellinp__random_delay_pulse_0__start 
        = ((IData)(vlSelfRef.__PVT__lsu_reqReady) & (IData)(vlSelfRef.__PVT__lsu_reqValid));
}
...
void Vtop_LSU___nba_sequent__TOP__top__LSU_0__0(Vtop_LSU* vlSelf) {
    ...
    if (vlSymsp->TOP.rst) {
        ...
        vlSelfRef.__PVT__lsu_reqReady = 0U;
        ...
        if (vlSelfRef.__PVT__RAM_0__DOT__random_delay_pulse_1__DOT__busy) {
            if ((1U == (IData)(vlSelfRef.__PVT__RAM_0__DOT__random_delay_pulse_1__DOT__delay_cnt))) {
                vlSelfRef.__PVT__lsu_reqReady = 1U;
                __Vdly__RAM_0__DOT__random_delay_pulse_1__DOT__busy = 0U;
                vlSelfRef.__PVT__RAM_0__DOT__random_delay_pulse_1__DOT__lfsr_en = 1U;
                __Vdly__RAM_0__DOT__random_delay_pulse_1__DOT__delay_cnt = 0U;
            } else {
