...
void Vtop_top___ico_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    vlSelfRef.__Vtableidx3 = ((((IData)(vlSelfRef.__PVT__RAM_AXI4LiteArbiter__DOT__M2_bready) 
                                << 5U) | ((IData)(vlSelfRef.__PVT__S_bvalid) 
                                          << 4U)) | 
                              (((IData)(vlSelfRef.__PVT__S_bresp) 
                                << 2U) | (((IData)(vlSelfRef.__PVT__RAM_AXI4LiteArbiter__DOT__W_master_sel) 
    ...
    vlSelfRef.__PVT__DRAM_bvalid = Vtop__ConstPool__TABLE_h450237dd_0
        [vlSelfRef.__Vtableidx3];
    vlSelfRef.__PVT__S_bready = Vtop__ConstPool__TABLE_h3a72a3a3_0
        [vlSelfRef.__Vtableidx3];
...
void Vtop_top___ico_sequent__TOP__top__2(Vtop_top* vlSelf) {
    ...
    if (vlSelfRef.__PVT__XBAR_Bridge_inst__DOT__W_state) {
        if (((IData)(vlSelfRef.__PVT__S_bready) & (IData)(vlSelfRef.__PVT__S_bvalid))) {
    ...
    vlSelfRef.__PVT__UART_bready = ((1U != (IData)(vlSelfRef.__PVT__XBAR_Bridge_inst__DOT__aw_sel_reg)) 
                                    && ((2U == (IData)(vlSelfRef.__PVT__XBAR_Bridge_inst__DOT__aw_sel_reg))
                                         ? (IData)(vlSelfRef.__PVT__S_bready)
    ...
    if ((1U == (IData)(vlSelfRef.__PVT__XBAR_Bridge_inst__DOT__aw_sel_reg))) {
        ...
        vlSelfRef.__PVT__CLINT_wdata = 0U;
        vlSelfRef.__PVT__CLINT_wstrb = 0U;
        vlSelfRef.__PVT__RAM_bready = vlSelfRef.__PVT__S_bready;
        vlSelfRef.__PVT__CLINT_bready = 0U;
        ...
        if ((2U == (IData)(vlSelfRef.__PVT__XBAR_Bridge_inst__DOT__aw_sel_reg))) {
            ...
            vlSelfRef.__PVT__CLINT_bready = vlSelfRef.__PVT__S_bready;
    ...
    vlSelfRef.__PVT__S_arvalid = ((IData)(vlSelfRef.__PVT__RAM_AXI4LiteArbiter__DOT__R_state)
                                   ? ((IData)(vlSelfRef.__PVT__RAM_AXI4LiteArbiter__DOT__R_master_sel)
    ...
    __Vtableidx7 = ((((IData)(vlSelfRef.__PVT__UART_bready) 
    ...
    __Vtableidx5 = ((((IData)(vlSelfRef.__PVT__RAM_bready) 
    ...
    __Vtableidx9 = ((((IData)(vlSelfRef.__PVT__CLINT_bready) 
           ...
           & ((2U != (IData)(vlSelfRef.__PVT__XBAR_Bridge_inst__DOT__ar_sel_reg)) 
              & ((4U == (IData)(vlSelfRef.__PVT__XBAR_Bridge_inst__DOT__ar_sel_reg))
                  ...
                  : ((~ (IData)(vlSelfRef.__VdfgRegularize_he2b63832_1_3)) 
                     & ((IData)(vlSelfRef.__VdfgRegularize_he2b63832_1_4) 
                        & (IData)(vlSelfRef.__PVT__RAM_AXI4LiteArbiter__DOT__S_rready))))));
    __Vtableidx6 = (((IData)(vlSelfRef.__PVT__XBAR_Bridge_inst__DOT__UART_rready) 
    ...
    __Vtableidx4 = (((IData)(vlSelfRef.__PVT__XBAR_Bridge_inst__DOT__MEM_rready) 
    ...
    __Vtableidx8 = (((IData)(vlSelfRef.__PVT__XBAR_Bridge_inst__DOT__CLINT_rready) 
