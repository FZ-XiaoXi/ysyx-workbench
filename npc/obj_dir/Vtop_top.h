...
class alignas(VL_CACHE_LINE_BYTES) Vtop_top final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*3:0*/ __PVT__RAM_awid;
        CData/*7:0*/ __PVT__RAM_awlen;
        CData/*2:0*/ __PVT__RAM_awsize;
        CData/*1:0*/ __PVT__RAM_awburst;
        CData/*0:0*/ __PVT__RAM_wlast;
        CData/*3:0*/ __PVT__UART_wstrb;
        CData/*0:0*/ __PVT__UART_awvalid;
        CData/*0:0*/ __PVT__UART_wvalid;
        CData/*0:0*/ __PVT__UART_bready;
        CData/*3:0*/ __PVT__UART_awid;
        CData/*7:0*/ __PVT__UART_awlen;
        CData/*2:0*/ __PVT__UART_awsize;
        CData/*1:0*/ __PVT__UART_awburst;
        CData/*0:0*/ __PVT__UART_wlast;
        CData/*3:0*/ __PVT__UART_bid;
        CData/*0:0*/ __PVT__UART_rlast;
        CData/*3:0*/ __PVT__UART_rid;
        CData/*3:0*/ __PVT__CLINT_wstrb;
        CData/*0:0*/ __PVT__CLINT_awvalid;
        CData/*0:0*/ __PVT__CLINT_wvalid;
        CData/*0:0*/ __PVT__CLINT_bready;
        CData/*3:0*/ __PVT__CLINT_awid;
        CData/*7:0*/ __PVT__CLINT_awlen;
        CData/*2:0*/ __PVT__CLINT_awsize;
        CData/*1:0*/ __PVT__CLINT_awburst;
        CData/*0:0*/ __PVT__CLINT_wlast;
        CData/*3:0*/ __PVT__CLINT_bid;
        CData/*0:0*/ __PVT__CLINT_rlast;
        CData/*3:0*/ __PVT__CLINT_rid;
