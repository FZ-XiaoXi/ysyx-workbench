...
class alignas(VL_CACHE_LINE_BYTES) Vtop_top final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__IROM_rvalid;
        CData/*1:0*/ __PVT__IROM_rresp;
        CData/*0:0*/ __PVT__DRAM_rvalid;
        ...
        CData/*1:0*/ __PVT__DRAM_rresp;
        CData/*3:0*/ __PVT__RAM_wstrb;
        CData/*0:0*/ __PVT__RAM_awvalid;
        CData/*0:0*/ __PVT__RAM_wvalid;
        CData/*0:0*/ __PVT__RAM_arvalid;
        CData/*0:0*/ __PVT__RAM_rready;
        ...
        CData/*0:0*/ __PVT__RAM_AXI4LiteArbiter__DOT__R_state_next;
        CData/*0:0*/ __PVT__RAM_AXI4LiteArbiter__DOT__r_priority;
        CData/*0:0*/ __PVT__RAM_AXI4LiteArbiter__DOT__r_pass;
        CData/*0:0*/ __PVT__RAM_AXI4LiteArbiter__DOT__r_pass_next;
        CData/*0:0*/ __PVT__RAM_AXI4LiteArbiter__DOT__W_state;
        CData/*0:0*/ __PVT__RAM_AXI4LiteArbiter__DOT__W_state_next;
        CData/*0:0*/ __PVT__RAM_AXI4LiteArbiter__DOT__w_priority;
        CData/*0:0*/ __PVT__RAM_AXI4LiteArbiter__DOT__w_pass;
        CData/*0:0*/ __PVT__RAM_AXI4LiteArbiter__DOT__w_pass_next;
