...
void VysyxSoCFull_ysyx_26010011_IFU_icache__pi1___ico_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__2(VysyxSoCFull_ysyx_26010011_IFU_icache__pi1* vlSelf) {
    ...
    vlSelfRef.__PVT__in_rdata = ((IData)(vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.debug_IFU_is_hit)
                                  ? (IData)((vlSelfRef.__PVT__cache_mem
                                             [(7U & 
...
void VysyxSoCFull_ysyx_26010011_IFU_icache__pi1___ico_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__3(VysyxSoCFull_ysyx_26010011_IFU_icache__pi1* vlSelf) {
    ...
    __Vtableidx3 = 0;
    // Body
    vlSelfRef.__PVT__ar_fire = ((IData)(vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.__PVT__arvalid) 
...
extern const VlUnpacked<CData/*0:0*/, 128> VysyxSoCFull__ConstPool__TABLE_he36aa42f_0;
...
void VysyxSoCFull_ysyx_26010011_IFU_icache__pi1___nba_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__0(VysyxSoCFull_ysyx_26010011_IFU_icache__pi1* vlSelf) {
    ...
    CData/*0:0*/ __VdlyVal__cache_valid__v8;
    __VdlyVal__cache_valid__v8 = 0;
    CData/*2:0*/ __VdlyDim0__cache_valid__v8;
    __VdlyDim0__cache_valid__v8 = 0;
    CData/*0:0*/ __VdlySet__cache_valid__v8;
    __VdlySet__cache_valid__v8 = 0;
    CData/*2:0*/ __VdlyDim0__cache_valid__v9;
    __VdlyDim0__cache_valid__v9 = 0;
    CData/*0:0*/ __VdlySet__cache_valid__v9;
    __VdlySet__cache_valid__v9 = 0;
    CData/*0:0*/ __VdlySet__cache_tag__v0;
    __VdlySet__cache_tag__v0 = 0;
    IData/*25:0*/ __VdlyVal__cache_tag__v8;
    __VdlyVal__cache_tag__v8 = 0;
    CData/*2:0*/ __VdlyDim0__cache_tag__v8;
    __VdlyDim0__cache_tag__v8 = 0;
    CData/*0:0*/ __VdlySet__cache_tag__v8;
    __VdlySet__cache_tag__v8 = 0;
    CData/*0:0*/ __VdlySet__cache_mem__v0;
    __VdlySet__cache_mem__v0 = 0;
    IData/*31:0*/ __VdlyVal__cache_mem__v8;
    __VdlyVal__cache_mem__v8 = 0;
    CData/*5:0*/ __VdlyLsb__cache_mem__v8;
    __VdlyLsb__cache_mem__v8 = 0;
    CData/*2:0*/ __VdlyDim0__cache_mem__v8;
    __VdlyDim0__cache_mem__v8 = 0;
    CData/*0:0*/ __VdlySet__cache_mem__v8;
    __VdlySet__cache_mem__v8 = 0;
    // Body
    __Vdly__burst_cnt = vlSelfRef.__PVT__burst_cnt;
    __VdlySet__cache_mem__v0 = 0U;
    __VdlySet__cache_mem__v8 = 0U;
    __VdlySet__cache_tag__v0 = 0U;
    __VdlySet__cache_tag__v8 = 0U;
    __VdlySet__cache_valid__v0 = 0U;
    __VdlySet__cache_valid__v8 = 0U;
    __VdlySet__cache_valid__v9 = 0U;
    if (((IData)(vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu.reset) 
        ...
        __VdlySet__cache_valid__v0 = 1U;
                ...
                & (~ (IData)(vlSelfRef.pc_flush)))) {
        __VdlyVal__cache_mem__v8 = vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.rdata;
        __VdlyLsb__cache_mem__v8 = (0x0000003fU & VL_SHIFTL_III(6,32,32, (IData)(vlSelfRef.__PVT__burst_cnt), 5U));
        __VdlyDim0__cache_mem__v8 = (7U & (vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.PC 
                                           >> 3U));
        __VdlySet__cache_mem__v8 = 1U;
        __VdlyVal__cache_tag__v8 = (vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.PC 
                                    >> 6U);
        __VdlyDim0__cache_tag__v8 = (7U & (vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.PC 
                                           >> 3U));
        __VdlySet__cache_tag__v8 = 1U;
        __VdlyVal__cache_valid__v8 = ((IData)(vlSelfRef.__PVT__r_fire) 
                                      & (IData)(vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.__PVT__rlast));
        __VdlyDim0__cache_valid__v8 = (7U & (vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.PC 
                                             >> 3U));
        __VdlySet__cache_valid__v8 = 1U;
    } else if ((((IData)(vlSelfRef.__PVT__r_fire) & 
                 (2U == (IData)(vlSelfRef.__PVT__state))) 
                & (IData)(vlSelfRef.pc_flush))) {
        __VdlyDim0__cache_valid__v9 = (7U & (vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.PC 
                                             >> 3U));
        __VdlySet__cache_valid__v9 = 1U;
    }
    __Vtableidx1 = ((((((IData)(vlSelfRef.__PVT__ar_fire) 
                        << 3U) | ((IData)(vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.__PVT__rlast) 
                                  << 2U)) | (((IData)(vlSelfRef.__PVT__burst_cnt) 
                                              << 1U) 
                                             | (IData)(vlSelfRef.__PVT__r_fire))) 
                     << 3U) | (((IData)(vlSelfRef.pc_flushed) 
                                << 2U) | (((IData)(vlSelfRef.pc_flush) 
                                           << 1U) | (IData)(vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu.reset))));
    __Vdly__burst_cnt = VysyxSoCFull__ConstPool__TABLE_he36aa42f_0
        [__Vtableidx1];
    vlSelfRef.__PVT__burst_cnt = __Vdly__burst_cnt;
    if (__VdlySet__cache_mem__v0) {
        vlSelfRef.__PVT__cache_mem[0U] = 0ULL;
        vlSelfRef.__PVT__cache_mem[1U] = 0ULL;
        vlSelfRef.__PVT__cache_mem[2U] = 0ULL;
        vlSelfRef.__PVT__cache_mem[3U] = 0ULL;
        vlSelfRef.__PVT__cache_mem[4U] = 0ULL;
        vlSelfRef.__PVT__cache_mem[5U] = 0ULL;
        vlSelfRef.__PVT__cache_mem[6U] = 0ULL;
        vlSelfRef.__PVT__cache_mem[7U] = 0ULL;
    }
    if (__VdlySet__cache_mem__v8) {
        vlSelfRef.__PVT__cache_mem[__VdlyDim0__cache_mem__v8] 
            = (((~ (0x00000000ffffffffULL << (IData)(__VdlyLsb__cache_mem__v8))) 
                & vlSelfRef.__PVT__cache_mem[__VdlyDim0__cache_mem__v8]) 
               | ((QData)((IData)(__VdlyVal__cache_mem__v8)) 
                  << (IData)(__VdlyLsb__cache_mem__v8)));
    }
    if (__VdlySet__cache_tag__v0) {
        vlSelfRef.__PVT__cache_tag[0U] = 0U;
        vlSelfRef.__PVT__cache_tag[1U] = 0U;
        vlSelfRef.__PVT__cache_tag[2U] = 0U;
        vlSelfRef.__PVT__cache_tag[3U] = 0U;
        vlSelfRef.__PVT__cache_tag[4U] = 0U;
        vlSelfRef.__PVT__cache_tag[5U] = 0U;
        vlSelfRef.__PVT__cache_tag[6U] = 0U;
        vlSelfRef.__PVT__cache_tag[7U] = 0U;
    }
    if (__VdlySet__cache_tag__v8) {
        vlSelfRef.__PVT__cache_tag[__VdlyDim0__cache_tag__v8] 
            = __VdlyVal__cache_tag__v8;
    }
    ...
    if (__VdlySet__cache_valid__v8) {
        vlSelfRef.__PVT__cache_valid[__VdlyDim0__cache_valid__v8] 
            = __VdlyVal__cache_valid__v8;
    }
    if (__VdlySet__cache_valid__v9) {
        vlSelfRef.__PVT__cache_valid[__VdlyDim0__cache_valid__v9] = 0U;
    }
