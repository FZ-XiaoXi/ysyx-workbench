...
bool Vencode42___024root___trigger_anySet__ico(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode42___024root___trigger_anySet__ico\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
extern const VlUnpacked<CData/*1:0*/, 32> Vencode42__ConstPool__TABLE_hfc4e910a_0;
extern const VlUnpacked<CData/*1:0*/, 32> Vencode42__ConstPool__TABLE_h71f80a71_0;
extern const VlUnpacked<IData/*31:0*/, 32> Vencode42__ConstPool__TABLE_h220cfc1d_0;
...
void Vencode42___024root___ico_sequent__TOP__0(Vencode42___024root* vlSelf) {
    ...
    vlSelfRef.y = Vencode42__ConstPool__TABLE_hfc4e910a_0
        [__Vtableidx1];
    if ((2U & Vencode42__ConstPool__TABLE_h71f80a71_0
         [__Vtableidx1])) {
        vlSelfRef.encode42__DOT__i = Vencode42__ConstPool__TABLE_h220cfc1d_0
            [__Vtableidx1];
    }
}
...
bool Vencode42___024root___eval_phase__ico(Vencode42___024root* vlSelf) {
    ...
    __VicoExecute = Vencode42___024root___trigger_anySet__ico(vlSelfRef.__VicoTriggered);
    if (__VicoExecute) {
