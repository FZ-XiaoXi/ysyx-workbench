...
VL_ATTR_COLD void VALU___024root__trace_init_sub__TOP__0(VALU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+2,0,"inA",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+3,0,"inB",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBit(c+6,0,"CF",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+7,0,"ZF",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void VALU___024root__trace_full_0_sub_0(VALU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+1,(vlSelfRef.cin));
    bufp->fullCData(oldp+2,(vlSelfRef.inA),4);
    bufp->fullCData(oldp+3,(vlSelfRef.inB),4);
    bufp->fullCData(oldp+4,(vlSelfRef.mode),3);
    bufp->fullCData(oldp+5,(vlSelfRef.out),4);
    bufp->fullBit(oldp+6,(vlSelfRef.CF));
    bufp->fullBit(oldp+7,(vlSelfRef.ZF));
    bufp->fullBit(oldp+8,(vlSelfRef.OF));
}
