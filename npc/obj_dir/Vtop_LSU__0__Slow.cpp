...
VL_ATTR_COLD void Vtop_LSU___ctor_var_reset(Vtop_LSU* vlSelf) {
    ...
    vlSelf->__PVT__RAM_0__DOT__state = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 14537912266358595398ull);
    vlSelf->__PVT__RAM_0__DOT__next_state = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 16856580351364493433ull);
    vlSelf->RAM_0__DOT____Vcellinp__random_delay_pulse_0__start = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5538676292073794484ull);
    vlSelf->__PVT__RAM_0__DOT__random_delay_pulse_0__DOT__out_unlock = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14538771503482325951ull);
    ...
    vlSelf->__PVT__RAM_0__DOT__random_delay_pulse_0__DOT__lock_state = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10998648045207337698ull);
    ...
    vlSelf->__PVT__RAM_0__DOT__random_delay_pulse_1__DOT__out_unlock = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6714249130493499306ull);
    ...
    vlSelf->__PVT__RAM_0__DOT__random_delay_pulse_1__DOT__lock_state = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9404052119123613053ull);
    ...
    vlSelf->__PVT__random_delay_pulse_1__DOT__out = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5645101256423011980ull);
