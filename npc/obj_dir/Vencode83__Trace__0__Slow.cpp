...
VL_ATTR_COLD void Vencode83___024root__trace_init_sub__TOP__0(Vencode83___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->popPrefix();
    tracep->pushPrefix("encode83", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+1,0,"x",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBit(c+2,0,"en",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+3,0,"y",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBit(c+4,0,"s",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void Vencode83___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vencode83___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vencode83___024root__trace_register(Vencode83___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vencode83___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vencode83___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vencode83___024root__trace_chg_0, 0, vlSelf);
    tracep->addCleanupCb(&Vencode83___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vencode83___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode83___024root__trace_const_0\n"); );
    // Body
    Vencode83___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vencode83___024root*>(voidSelf);
    Vencode83__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
}

VL_ATTR_COLD void Vencode83___024root__trace_full_0_sub_0(Vencode83___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vencode83___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode83___024root__trace_full_0\n"); );
    // Body
    Vencode83___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vencode83___024root*>(voidSelf);
    Vencode83__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vencode83___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vencode83___024root__trace_full_0_sub_0(Vencode83___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode83___024root__trace_full_0_sub_0\n"); );
    Vencode83__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    bufp->fullBit(oldp+4,(vlSelfRef.s));
    bufp->fullCData(oldp+5,(vlSelfRef.seg),7);
    bufp->fullIData(oldp+6,(vlSelfRef.encode83__DOT__i),32);
}
