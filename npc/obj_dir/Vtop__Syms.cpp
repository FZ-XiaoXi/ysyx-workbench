    ...
    , TOP__top__REG_0{this, Verilated::catName(namep, "top.REG_0")}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        ...
        __Vscope_top__IFU_0.varInsert(__Vfinal,"state", &(TOP__top__IFU_0.state), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0,0);
        __Vscope_top__LSU_0.varInsert(__Vfinal,"state", &(TOP__top__LSU_0.state), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0,0);
