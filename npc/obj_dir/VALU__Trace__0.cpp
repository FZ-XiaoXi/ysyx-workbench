...
void VALU___024root__trace_chg_0_sub_0(VALU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+3,(vlSelfRef.inA),4);
    bufp->chgCData(oldp+4,(vlSelfRef.inB),4);
    bufp->chgCData(oldp+5,(vlSelfRef.mode),3);
    bufp->chgCData(oldp+6,(vlSelfRef.out),4);
    bufp->chgBit(oldp+7,(vlSelfRef.CF));
    bufp->chgBit(oldp+8,(vlSelfRef.ZF));
    bufp->chgBit(oldp+9,(vlSelfRef.OF));
    bufp->chgBit(oldp+10,((1U == (IData)(vlSelfRef.mode))));
}
