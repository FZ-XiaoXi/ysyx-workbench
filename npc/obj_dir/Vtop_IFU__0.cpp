...
extern const VlUnpacked<CData/*0:0*/, 64> Vtop__ConstPool__TABLE_hca82e40b_0;
extern const VlUnpacked<CData/*0:0*/, 64> Vtop__ConstPool__TABLE_h5523db97_0;
extern const VlUnpacked<CData/*1:0*/, 64> Vtop__ConstPool__TABLE_hbbcb872e_0;
...
void Vtop_IFU___ico_sequent__TOP__top__IFU_0__1(Vtop_IFU* vlSelf) {
    ...
    __Vtableidx2 = 0;
    // Body
    __Vtableidx1 = ((((IData)(vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_1__DOT__out_unlock) 
                      << 5U) | (((IData)(vlSelfRef.__PVT__pmem_respReady) 
                                 << 4U) | ((IData)(vlSelfRef.__PVT__pmem_respValid) 
                                           << 3U))) 
                    | (((IData)(vlSymsp->TOP__top__IDU_0.__PVT__wbu_final) 
                        << 2U) | (IData)(vlSelfRef.state)));
    vlSelfRef.__PVT__bus_valid = Vtop__ConstPool__TABLE_hca82e40b_0
        [__Vtableidx1];
    vlSelfRef.__PVT__pmem_reqValid = Vtop__ConstPool__TABLE_h5523db97_0
        [__Vtableidx1];
    vlSelfRef.__PVT__next_state = Vtop__ConstPool__TABLE_hbbcb872e_0
        [__Vtableidx1];
    vlSelfRef.ROM_0__DOT____Vcellinp__random_delay_pulse_0__start 
        = ((IData)(vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_1__DOT__out_unlock) 
           & (IData)(vlSelfRef.__PVT__pmem_reqValid));
    __Vtableidx2 = ((((((IData)(vlSelfRef.__PVT__pmem_respValid) 
                        << 3U) | ((IData)(vlSelfRef.__PVT__pmem_respReady) 
                                  << 2U)) | (((IData)(vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_0__DOT__out_unlock) 
                                              << 1U) 
                                             | (IData)(vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_1__DOT__out_unlock))) 
                     << 3U) | (((IData)(vlSelfRef.__PVT__pmem_reqValid) 
                                << 2U) | (IData)(vlSelfRef.__PVT__ROM_0__DOT__state)));
    vlSelfRef.__PVT__ROM_0__DOT__next_state = Vtop__ConstPool__TABLE_hadeda171_0
        [__Vtableidx2];
}
...
void Vtop_IFU___nba_sequent__TOP__top__IFU_0__0(Vtop_IFU* vlSelf) {
    ...
    if (((IData)(vlSelfRef.__PVT__pmem_reqValid) & (IData)(vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_1__DOT__out_unlock))) {
    ...
    if (vlSymsp->TOP.rst) {
        vlSelfRef.__PVT__ROM_0__DOT__state = 0U;
        vlSelfRef.state = 0U;
        vlSelfRef.__PVT__PC = 0x80000000U;
    } else {
        vlSelfRef.__PVT__ROM_0__DOT__state = vlSelfRef.__PVT__ROM_0__DOT__next_state;
...
void Vtop_IFU___nba_sequent__TOP__top__IFU_0__1(Vtop_IFU* vlSelf) {
    ...
    if (vlSymsp->TOP.rst) {
        ...
        vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_0__DOT__out_unlock = 0U;
        ...
        vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_1__DOT__out_unlock = 0U;
    } else {
        ...
        if (vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_0__DOT__busy) {
            if ((1U == (IData)(vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_0__DOT__delay_cnt))) {
                vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_0__DOT__out_unlock = 1U;
                __Vdly__ROM_0__DOT__random_delay_pulse_0__DOT__busy = 0U;
                vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_0__DOT__lfsr_en = 1U;
                __Vdly__ROM_0__DOT__random_delay_pulse_0__DOT__delay_cnt = 0U;
            } else {
        ...
        if (vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_1__DOT__busy) {
            if ((1U == (IData)(vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_1__DOT__delay_cnt))) {
                vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_1__DOT__out_unlock = 1U;
                __Vdly__ROM_0__DOT__random_delay_pulse_1__DOT__busy = 0U;
                vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_1__DOT__lfsr_en = 1U;
                __Vdly__ROM_0__DOT__random_delay_pulse_1__DOT__delay_cnt = 0U;
            } else {
    ...
    vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_0__DOT__lock_state = 0U;
    vlSelfRef.__PVT__ROM_0__DOT__random_delay_pulse_1__DOT__lock_state = 0U;
