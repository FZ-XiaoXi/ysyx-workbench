...
#ifndef VERILATED_VYSYXSOCFULL_YSYX_26010011_REG_H_
#define VERILATED_VYSYXSOCFULL_YSYX_26010011_REG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VysyxSoCFull_ysyx_26010011_REG final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VysyxSoCFull_ysyx_26010011_REG(VysyxSoCFull__Syms* symsp, const char* v__name);
    ~VysyxSoCFull_ysyx_26010011_REG();
    VL_UNCOPYABLE(VysyxSoCFull_ysyx_26010011_REG);
