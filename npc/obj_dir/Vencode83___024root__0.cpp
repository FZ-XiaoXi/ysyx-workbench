...
void Vencode83___024root___eval_triggers__ico(Vencode83___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        Vencode83___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
    }
#endif
}

bool Vencode83___024root___trigger_anySet__ico(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencode83___024root___trigger_anySet__ico\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
void Vencode83___024root___ico_sequent__TOP__0(Vencode83___024root* vlSelf) {
    ...
    __Vtableidx1 = 0;
    // Body
    vlSelfRef.s = (0U != (IData)(vlSelfRef.x));
    __Vtableidx1 = (((IData)(vlSelfRef.x) << 1U) | (IData)(vlSelfRef.en));
    vlSelfRef.y = Vencode83__ConstPool__TABLE_hae94bb89_0
        [__Vtableidx1];
    if ((2U & Vencode83__ConstPool__TABLE_hc190debf_0
         [__Vtableidx1])) {
        vlSelfRef.encode83__DOT__i = Vencode83__ConstPool__TABLE_hc8d3e0ac_0
            [__Vtableidx1];
    }
}
...
bool Vencode83___024root___eval_phase__ico(Vencode83___024root* vlSelf) {
    ...
    __VicoExecute = Vencode83___024root___trigger_anySet__ico(vlSelfRef.__VicoTriggered);
    if (__VicoExecute) {
...
void Vencode83___024root___eval(Vencode83___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vencode83___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("vsrc/encode83.v", 1, "", "Input combinational region did not converge after 100 tries");
        }
        __VicoIterCount = ((IData)(1U) + __VicoIterCount);
    } while (Vencode83___024root___eval_phase__ico(vlSelf));
}
