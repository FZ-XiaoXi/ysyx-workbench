...
VL_ATTR_COLD void Vencode42___024root__trace_register(Vencode42___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vencode42___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vencode42___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vencode42___024root__trace_chg_0, 0, vlSelf);
...
VL_ATTR_COLD void Vencode42___024root__trace_full_0_sub_0(Vencode42___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+4,(vlSelfRef.encode42__DOT__i),32);
}
