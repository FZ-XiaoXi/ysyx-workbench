    ...
    if (vlSymsp->TOP.rst) {
        ...
        if (vlSelfRef.__PVT__WCSREN) {
            if ((0x0305U != (vlSymsp->TOP__top__IFU_0.__PVT__PC_command 
                             >> 0x00000014U))) {
                if ((0x0341U != (vlSymsp->TOP__top__IFU_0.__PVT__PC_command 
                                 >> 0x00000014U))) {
                    if ((0x0342U != (vlSymsp->TOP__top__IFU_0.__PVT__PC_command 
                                     >> 0x00000014U))) {
                        if ((0x0300U == (vlSymsp->TOP__top__IFU_0.__PVT__PC_command 
                                         >> 0x00000014U))) {
        ...
        } else if ((0x00000073U == vlSymsp->TOP__top__IFU_0.__PVT__PC_command)) {
