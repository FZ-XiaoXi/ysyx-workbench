...
VL_ATTR_COLD void Vvga___024root__trace_init_sub__TOP__0(Vvga___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+18,0,"clken",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+19,0,"clk_freq",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+20,0,"countlimit",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+8,0,"reset",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+17,0,"vga_data",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 23,0);
...
VL_ATTR_COLD void Vvga___024root__trace_full_0_sub_0(Vvga___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    bufp->fullSData(oldp+1,(((IData)(vlSelfRef.vga__DOT__u_vga_ctrl__DOT__v_valid)
                              ? (0x000003ffU & ((IData)(vlSelfRef.vga__DOT__u_vga_ctrl__DOT__y_cnt) 
                                                - (IData)(0x0024U)))
                              : 0U)),10);
    ...
    bufp->fullSData(oldp+4,(((IData)(vlSelfRef.vga__DOT__u_vga_ctrl__DOT__h_valid)
                              ? (0x000003ffU & ((IData)(vlSelfRef.vga__DOT__u_vga_ctrl__DOT__x_cnt) 
                                                - (IData)(0x0091U)))
                              : 0U)),10);
