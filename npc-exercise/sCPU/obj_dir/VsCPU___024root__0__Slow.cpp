...
VL_ATTR_COLD void VsCPU___024root___eval_initial__TOP(VsCPU___024root* vlSelf);
...
VL_ATTR_COLD void VsCPU___024root___eval_initial(VsCPU___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VsCPU___024root___eval_initial__TOP(vlSelf);
    VsCPU___024root____Vm_traceActivitySetAll(vlSelf);
}

VL_ATTR_COLD void VsCPU___024root___eval_initial__TOP(VsCPU___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsCPU___024root___eval_initial__TOP\n"); );
    VsCPU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.sCPU__DOT__PROGRAM[0U] = 0x8aU;
    vlSelfRef.sCPU__DOT__PROGRAM[1U] = 0x90U;
    vlSelfRef.sCPU__DOT__PROGRAM[2U] = 0xa0U;
    vlSelfRef.sCPU__DOT__PROGRAM[3U] = 0xb1U;
    vlSelfRef.sCPU__DOT__PROGRAM[4U] = 0x17U;
    vlSelfRef.sCPU__DOT__PROGRAM[5U] = 0x29U;
    vlSelfRef.sCPU__DOT__PROGRAM[6U] = 0xd1U;
    vlSelfRef.sCPU__DOT__PROGRAM[7U] = 0x42U;
    vlSelfRef.sCPU__DOT__PROGRAM[8U] = 0xe3U;
}
...
VL_ATTR_COLD void VsCPU___024root___stl_sequent__TOP__0(VsCPU___024root* vlSelf) {
    ...
    vlSelfRef.regA = vlSelfRef.sCPU__DOT__R[(3U & (IData)(vlSelfRef.sCPU__DOT____VdfgRegularize_heb7aa42f_0_0))];
    vlSelfRef.regB = vlSelfRef.sCPU__DOT__R[((3U == 
                                              (3U & 
                                               ((IData)(vlSelfRef.sCPU__DOT____VdfgRegularize_heb7aa42f_0_0) 
                                                >> 6U)))
                                              ? 0U : 
    ...
    vlSelfRef.sCPU__DOT__adder8_0__DOT__fa7__DOT____VdfgRegularize_h6c152500_0_0 
        = (1U & (((IData)(vlSelfRef.regA) ^ (IData)(vlSelfRef.regB)) 
                 >> 7U));
...
VL_ATTR_COLD void VsCPU___024root___ctor_var_reset(VsCPU___024root* vlSelf) {
    ...
    vlSelf->regA = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 14566424646751129975ull);
    vlSelf->regB = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 1813533423382037126ull);
    ...
    for (int __Vi0 = 0; __Vi0 < 9; ++__Vi0) {
        vlSelf->sCPU__DOT__PROGRAM[__Vi0] = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 4842813244062317578ull);
    }
