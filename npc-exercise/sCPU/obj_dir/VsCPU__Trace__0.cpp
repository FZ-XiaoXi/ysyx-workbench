...
void VsCPU___024root__trace_chg_0_sub_0(VsCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+55,(vlSelfRef.temp),8);
    bufp->chgCData(oldp+56,(vlSelfRef.sCPU__DOT__CLKcounter),2);
    bufp->chgCData(oldp+57,(((0U == (IData)(vlSelfRef.sCPU__DOT__CLKcounter))
                              ? 1U : ((1U == (IData)(vlSelfRef.sCPU__DOT__CLKcounter))
                                       ? 2U : ((2U 
                                                == (IData)(vlSelfRef.sCPU__DOT__CLKcounter))
                                                ? 4U
                                                : 0U)))),3);
    bufp->chgBit(oldp+58,((IData)(((0xc0U == (0xc0U 
                                              & (IData)(vlSelfRef.sCPU__DOT____VdfgRegularize_heb7aa42f_0_0))) 
                                   & ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                      == (IData)(vlSelfRef.sCPU__DOT__regB))))));
    bufp->chgCData(oldp+59,((0x0000000fU & ((IData)(vlSelfRef.segnum) 
                                            >> 4U))),4);
    bufp->chgCData(oldp+60,((0x0000000fU & (IData)(vlSelfRef.segnum))),4);
}
