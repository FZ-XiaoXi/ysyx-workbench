...
VL_ATTR_COLD void VsCPU___024root__trace_init_sub__TOP__0(VsCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+51,0,"segH",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 6,0);
    tracep->declBus(c+52,0,"segL",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 6,0);
    tracep->declBus(c+53,0,"segnum",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+54,0,"PC",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+55,0,"temp",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+56,0,"tempR1",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+57,0,"tempR2",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+58,0,"tempR3",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+59,0,"tempR0",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->popPrefix();
    ...
    tracep->popPrefix();
    tracep->declBus(c+60,0,"CLKcounter",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+61,0,"step",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    ...
    tracep->declBit(c+62,0,"PCJFlag",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+55,0,"added",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    ...
    tracep->declBus(c+63,0,"hex",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+51,0,"seg",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 6,0);
    tracep->popPrefix();
    tracep->pushPrefix("SegL", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+64,0,"hex",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBus(c+55,0,"sum",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+17,0,"cout",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    ...
    tracep->declBit(c+29,0,"C",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+33,0,"C",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+37,0,"C",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+45,0,"C",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void VsCPU___024root__trace_full_0_sub_0(VsCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+17,((((((2U & ((0x03fffffeU 
    ...
    bufp->fullBit(oldp+18,((1U & (IData)(vlSelfRef.sCPU__DOT__regA))));
    bufp->fullBit(oldp+19,((1U & (IData)(vlSelfRef.sCPU__DOT__regB))));
    bufp->fullBit(oldp+20,((1U & ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                  ^ (IData)(vlSelfRef.sCPU__DOT__regB)))));
    bufp->fullBit(oldp+21,(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa1__DOT__C));
    bufp->fullBit(oldp+22,((1U & ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                  >> 1U))));
    bufp->fullBit(oldp+23,((1U & ((IData)(vlSelfRef.sCPU__DOT__regB) 
                                  >> 1U))));
    bufp->fullBit(oldp+24,(((IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa1__DOT____VdfgRegularize_h6c152500_0_0) 
                            ^ (IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa1__DOT__C))));
    bufp->fullBit(oldp+25,(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa2__DOT__C));
    bufp->fullBit(oldp+26,((1U & ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                  >> 2U))));
    bufp->fullBit(oldp+27,((1U & ((IData)(vlSelfRef.sCPU__DOT__regB) 
                                  >> 2U))));
    bufp->fullBit(oldp+28,(((IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa2__DOT____VdfgRegularize_h6c152500_0_0) 
                            ^ (IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa2__DOT__C))));
    bufp->fullBit(oldp+29,(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa3__DOT__C));
    bufp->fullBit(oldp+30,((1U & ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                  >> 3U))));
    bufp->fullBit(oldp+31,((1U & ((IData)(vlSelfRef.sCPU__DOT__regB) 
                                  >> 3U))));
    bufp->fullBit(oldp+32,(((IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa3__DOT____VdfgRegularize_h6c152500_0_0) 
                            ^ (IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa3__DOT__C))));
    bufp->fullBit(oldp+33,(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa4__DOT__C));
    bufp->fullBit(oldp+34,((1U & ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                  >> 4U))));
    bufp->fullBit(oldp+35,((1U & ((IData)(vlSelfRef.sCPU__DOT__regB) 
                                  >> 4U))));
    bufp->fullBit(oldp+36,(((IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa4__DOT____VdfgRegularize_h6c152500_0_0) 
                            ^ (IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa4__DOT__C))));
    bufp->fullBit(oldp+37,(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa5__DOT__C));
    bufp->fullBit(oldp+38,((1U & ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                  >> 5U))));
    bufp->fullBit(oldp+39,((1U & ((IData)(vlSelfRef.sCPU__DOT__regB) 
                                  >> 5U))));
    bufp->fullBit(oldp+40,(((IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa5__DOT____VdfgRegularize_h6c152500_0_0) 
                            ^ (IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa5__DOT__C))));
    bufp->fullBit(oldp+41,(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa6__DOT__C));
    bufp->fullBit(oldp+42,((1U & ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                  >> 6U))));
    bufp->fullBit(oldp+43,((1U & ((IData)(vlSelfRef.sCPU__DOT__regB) 
                                  >> 6U))));
    bufp->fullBit(oldp+44,(((IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa6__DOT____VdfgRegularize_h6c152500_0_0) 
                            ^ (IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa6__DOT__C))));
    bufp->fullBit(oldp+45,(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa7__DOT__C));
    bufp->fullBit(oldp+46,((1U & ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                  >> 7U))));
    bufp->fullBit(oldp+47,((1U & ((IData)(vlSelfRef.sCPU__DOT__regB) 
                                  >> 7U))));
    bufp->fullBit(oldp+48,(((IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa7__DOT____VdfgRegularize_h6c152500_0_0) 
                            ^ (IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa7__DOT__C))));
    bufp->fullBit(oldp+49,((1U & ((((IData)(vlSelfRef.sCPU__DOT__regA) 
                                    & (IData)(vlSelfRef.sCPU__DOT__regB)) 
                                   >> 7U) ^ ((IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa7__DOT__C) 
                                             & (IData)(vlSelfRef.sCPU__DOT__adder8_0__DOT__fa7__DOT____VdfgRegularize_h6c152500_0_0))))));
    bufp->fullBit(oldp+50,(vlSelfRef.clk));
    bufp->fullCData(oldp+51,(vlSelfRef.segH),7);
    bufp->fullCData(oldp+52,(vlSelfRef.segL),7);
    bufp->fullCData(oldp+53,(vlSelfRef.segnum),8);
    bufp->fullCData(oldp+54,(vlSelfRef.PC),4);
    bufp->fullCData(oldp+55,(vlSelfRef.temp),8);
    bufp->fullCData(oldp+56,(vlSelfRef.tempR1),8);
    bufp->fullCData(oldp+57,(vlSelfRef.tempR2),8);
    bufp->fullCData(oldp+58,(vlSelfRef.tempR3),8);
    bufp->fullCData(oldp+59,(vlSelfRef.tempR0),8);
    bufp->fullCData(oldp+60,(vlSelfRef.sCPU__DOT__CLKcounter),2);
    bufp->fullCData(oldp+61,(((0U == (IData)(vlSelfRef.sCPU__DOT__CLKcounter))
                               ? 1U : ((1U == (IData)(vlSelfRef.sCPU__DOT__CLKcounter))
                                        ? 2U : ((2U 
                                                 == (IData)(vlSelfRef.sCPU__DOT__CLKcounter))
                                                 ? 4U
                                                 : 0U)))),3);
    bufp->fullBit(oldp+62,((IData)(((0xc0U == (0xc0U 
                                               & (IData)(vlSelfRef.sCPU__DOT____VdfgRegularize_heb7aa42f_0_0))) 
                                    & ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                       != (IData)(vlSelfRef.sCPU__DOT__regB))))));
    bufp->fullCData(oldp+63,((0x0000000fU & ((IData)(vlSelfRef.segnum) 
                                             >> 4U))),4);
    bufp->fullCData(oldp+64,((0x0000000fU & (IData)(vlSelfRef.segnum))),4);
}
