...
VL_ATTR_COLD void VsCPU___024root__trace_init_sub__TOP__0(VsCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->popPrefix();
    tracep->declBus(c+56,0,"CLKcounter",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+57,0,"step",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    ...
    tracep->declBit(c+58,0,"PCJFlag",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    for (int i = 0; i < 9; ++i) {
        tracep->declBus(c+61+i*1,0,"",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, true,(i+0), 7,0);
    }
    tracep->popPrefix();
    tracep->pushPrefix("SegH", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+59,0,"hex",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBit(c+70,0,"C",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void VsCPU___024root__trace_const_0_sub_0(VsCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+61,(vlSelfRef.sCPU__DOT__PROGRAM[0]),8);
    bufp->fullCData(oldp+62,(vlSelfRef.sCPU__DOT__PROGRAM[1]),8);
    bufp->fullCData(oldp+63,(vlSelfRef.sCPU__DOT__PROGRAM[2]),8);
    bufp->fullCData(oldp+64,(vlSelfRef.sCPU__DOT__PROGRAM[3]),8);
    bufp->fullCData(oldp+65,(vlSelfRef.sCPU__DOT__PROGRAM[4]),8);
    bufp->fullCData(oldp+66,(vlSelfRef.sCPU__DOT__PROGRAM[5]),8);
    bufp->fullCData(oldp+67,(vlSelfRef.sCPU__DOT__PROGRAM[6]),8);
    bufp->fullCData(oldp+68,(vlSelfRef.sCPU__DOT__PROGRAM[7]),8);
    bufp->fullCData(oldp+69,(vlSelfRef.sCPU__DOT__PROGRAM[8]),8);
...
VL_ATTR_COLD void VsCPU___024root__trace_full_0_sub_0(VsCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+56,(vlSelfRef.sCPU__DOT__CLKcounter),2);
    bufp->fullCData(oldp+57,(((0U == (IData)(vlSelfRef.sCPU__DOT__CLKcounter))
                               ? 1U : ((1U == (IData)(vlSelfRef.sCPU__DOT__CLKcounter))
                                        ? 2U : ((2U 
                                                 == (IData)(vlSelfRef.sCPU__DOT__CLKcounter))
                                                 ? 4U
                                                 : 0U)))),3);
    bufp->fullBit(oldp+58,((IData)(((0xc0U == (0xc0U 
                                               & (IData)(vlSelfRef.sCPU__DOT____VdfgRegularize_heb7aa42f_0_0))) 
                                    & (0U != ((IData)(vlSelfRef.sCPU__DOT__regA) 
                                              ^ (IData)(vlSelfRef.sCPU__DOT__regB)))))));
    bufp->fullCData(oldp+59,((0x0000000fU & ((IData)(vlSelfRef.segnum) 
                                             >> 4U))),4);
    bufp->fullCData(oldp+60,((0x0000000fU & (IData)(vlSelfRef.segnum))),4);
}
