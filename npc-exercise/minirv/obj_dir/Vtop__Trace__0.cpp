...
void Vtop___024root__trace_chg_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+131,(vlSelfRef.GPRTEST[0]),32);
    bufp->chgIData(oldp+132,(vlSelfRef.GPRTEST[1]),32);
    bufp->chgIData(oldp+133,(vlSelfRef.GPRTEST[2]),32);
    bufp->chgIData(oldp+134,(vlSelfRef.GPRTEST[3]),32);
    bufp->chgIData(oldp+135,(vlSelfRef.GPRTEST[4]),32);
    bufp->chgIData(oldp+136,(vlSelfRef.GPRTEST[5]),32);
    bufp->chgIData(oldp+137,(vlSelfRef.GPRTEST[6]),32);
    bufp->chgIData(oldp+138,(vlSelfRef.GPRTEST[7]),32);
    bufp->chgIData(oldp+139,(vlSelfRef.GPRTEST[8]),32);
    bufp->chgIData(oldp+140,(vlSelfRef.GPRTEST[9]),32);
    bufp->chgIData(oldp+141,(vlSelfRef.GPRTEST[10]),32);
    bufp->chgIData(oldp+142,(vlSelfRef.GPRTEST[11]),32);
    bufp->chgIData(oldp+143,(vlSelfRef.GPRTEST[12]),32);
    bufp->chgIData(oldp+144,(vlSelfRef.GPRTEST[13]),32);
    bufp->chgIData(oldp+145,(vlSelfRef.GPRTEST[14]),32);
    bufp->chgIData(oldp+146,(vlSelfRef.GPRTEST[15]),32);
    bufp->chgIData(oldp+147,(vlSelfRef.GPRTEST[16]),32);
    bufp->chgIData(oldp+148,(vlSelfRef.GPRTEST[17]),32);
    bufp->chgIData(oldp+149,(vlSelfRef.GPRTEST[18]),32);
    bufp->chgIData(oldp+150,(vlSelfRef.GPRTEST[19]),32);
    bufp->chgIData(oldp+151,(vlSelfRef.GPRTEST[20]),32);
    bufp->chgIData(oldp+152,(vlSelfRef.GPRTEST[21]),32);
    bufp->chgIData(oldp+153,(vlSelfRef.GPRTEST[22]),32);
    bufp->chgIData(oldp+154,(vlSelfRef.GPRTEST[23]),32);
    bufp->chgIData(oldp+155,(vlSelfRef.GPRTEST[24]),32);
    bufp->chgIData(oldp+156,(vlSelfRef.GPRTEST[25]),32);
    bufp->chgIData(oldp+157,(vlSelfRef.GPRTEST[26]),32);
    bufp->chgIData(oldp+158,(vlSelfRef.GPRTEST[27]),32);
    bufp->chgIData(oldp+159,(vlSelfRef.GPRTEST[28]),32);
    bufp->chgIData(oldp+160,(vlSelfRef.GPRTEST[29]),32);
    bufp->chgIData(oldp+161,(vlSelfRef.GPRTEST[30]),32);
    bufp->chgIData(oldp+162,(vlSelfRef.GPRTEST[31]),32);
    bufp->chgIData(oldp+163,(((IData)(vlSelfRef.top__DOT__IDU_0__DOT__isI)
                               ...
                               : ((IData)(vlSelfRef.LSU_WEN)
                                   ...
                                   : ((0x37U == (0x0000007fU 
                                       ...
                                       ? (0xfffff000U 
                                          & vlSelfRef.PC_command)
                                       : 0U)))),32);
    bufp->chgIData(oldp+164,(((IData)(4U) + vlSelfRef.PC)),32);
    bufp->chgBit(oldp+165,((0x37U == (0x0000007fU & vlSelfRef.PC_command))));
    ...
    bufp->chgCData(oldp+168,((0x0000001fU & (vlSelfRef.PC_command 
                                             >> 0x00000014U))),5);
    bufp->chgIData(oldp+169,(((IData)(vlSelfRef.top__DOT__IDU_0__DOT__isLOAD)
                               ...
                               : ((IData)(vlSelfRef.top__DOT__IDU_0__DOT__isJALR)
                                   ...
                                   : ((IData)(vlSelfRef.top__DOT__IDU_0__DOT__isWRITE)
                                       ...
                                       : 0xffffffffU)))),32);
    bufp->chgIData(oldp+170,(((IData)(vlSelfRef.top__DOT____VdfgRegularize_he2b63832_0_0)
                               ? vlSelfRef.top__DOT__rs1_val
                               : vlSelfRef.LSU_writedata)),32);
    bufp->chgBit(oldp+171,((0x00100073U == vlSelfRef.PC_command)));
    bufp->chgSData(oldp+172,((((IData)(vlSelfRef.top__DOT__IDU_0__DOT____VdfgRegularize_h52656aab_0_5) 
                               | ((IData)(vlSelfRef.top__DOT__IDU_0__DOT__isLW) 
                                  | ((IData)(vlSelfRef.top__DOT__IDU_0__DOT____VdfgRegularize_h52656aab_0_6) 
                                     | (IData)(vlSelfRef.LSU_WEN)))) 
                              << 9U)),10);
    bufp->chgIData(oldp+173,((vlSelfRef.top__DOT__EXU_0__DOT__inA 
                              + ((IData)(vlSelfRef.top__DOT____VdfgRegularize_he2b63832_0_0)
                                  ? vlSelfRef.top__DOT__rs1_val
                                  : vlSelfRef.LSU_writedata))),32);
    bufp->chgCData(oldp+174,((0x0000007fU & vlSelfRef.PC_command)),7);
    bufp->chgCData(oldp+175,((7U & (vlSelfRef.PC_command 
                                    >> 0x0000000cU))),3);
    bufp->chgCData(oldp+176,((vlSelfRef.PC_command 
                              >> 0x00000019U)),7);
    bufp->chgSData(oldp+177,((vlSelfRef.PC_command 
                              >> 0x00000014U)),12);
    bufp->chgSData(oldp+178,(((0x00000fe0U & (vlSelfRef.PC_command 
                                              >> 0x00000014U)) 
                              | (0x0000001fU & (vlSelfRef.PC_command 
                                                >> 7U)))),12);
    bufp->chgSData(oldp+179,(((((2U & (vlSelfRef.PC_command 
                                       >> 0x0000001eU)) 
                              ...
                              | ((0x000003f0U & (vlSelfRef.PC_command 
                                 ...
                                 | (0x0000000fU & (vlSelfRef.PC_command 
                                                   >> 8U))))),12);
    bufp->chgIData(oldp+180,((vlSelfRef.PC_command 
                              >> 0x0000000cU)),20);
    bufp->chgIData(oldp+181,(((0x00080000U & (vlSelfRef.PC_command 
                                              >> 0x0000000cU)) 
                              | ((0x0007f800U & (vlSelfRef.PC_command 
                                 ...
                                 | ((0x00000400U & 
                                    ...
                                    | (0x000003ffU 
                                       & (vlSelfRef.PC_command 
                                          >> 0x00000015U)))))),20);
    bufp->chgBit(oldp+182,((IData)((0x00000013U == 
                                    (0x0000707fU & vlSelfRef.PC_command)))));
    bufp->chgBit(oldp+183,((IData)((3U == (0x0000707fU 
                                           & vlSelfRef.PC_command)))));
    bufp->chgCData(oldp+184,((((IData)(vlSelfRef.top__DOT__IDU_0__DOT__isADD) 
                                         ...
                                         (((IData)(vlSelfRef.LSU_WEN) 
                                          ...
                                          ((0x37U == 
                                            (0x0000007fU 
                                             & vlSelfRef.PC_command)) 
                                           << 1U))))),6);
    bufp->chgIData(oldp+185,(VL_SHIFTL_III(32,32,32, vlSelfRef.LSU_writedata, 8U)),32);
    bufp->chgIData(oldp+186,(VL_SHIFTL_III(32,32,32, vlSelfRef.LSU_writedata, 0x00000010U)),32);
    bufp->chgIData(oldp+187,(VL_SHIFTL_III(32,32,32, vlSelfRef.LSU_writedata, 0x00000018U)),32);
    bufp->chgIData(oldp+188,(((2U & vlSelfRef.LSU_address)
