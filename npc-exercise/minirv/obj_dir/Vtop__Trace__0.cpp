...
void Vtop___024root__trace_chg_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[2U]))) {
        bufp->chgIData(oldp+101,(vlSelfRef.top__DOT__EXU_0__DOT__out),32);
        bufp->chgBit(oldp+102,(vlSelfRef.top__DOT__IDU_0__DOT__isADD));
        bufp->chgBit(oldp+103,(vlSelfRef.top__DOT__IDU_0__DOT__isI));
        bufp->chgIData(oldp+104,(vlSelfRef.top__DOT__rs1_val),32);
        bufp->chgIData(oldp+105,(vlSelfRef.top__DOT__EXU_0__DOT__inA),32);
        bufp->chgBit(oldp+106,(vlSelfRef.top__DOT__IDU_0__DOT__isJALR));
        bufp->chgSData(oldp+107,(((IData)(vlSelfRef.top__DOT__IDU_0__DOT____VdfgRegularize_h52656aab_0_1) 
                                  << 9U)),10);
    }
    ...
    bufp->chgIData(oldp+149,(((IData)(vlSelfRef.top__DOT__IDU_0__DOT__isI)
                               ...
                               : ((0x37U == (0x0000007fU 
                                   ...
                                   : 0U))),32);
    bufp->chgIData(oldp+150,(((IData)(4U) + vlSelfRef.PC)),32);
    bufp->chgBit(oldp+151,((0x37U == (0x0000007fU & vlSelfRef.PC_command))));
    ...
    bufp->chgIData(oldp+156,(((IData)(vlSelfRef.top__DOT__IDU_0__DOT__isJALR)
                               ...
                               : (((IData)(vlSelfRef.top__DOT__IDU_0__DOT____VdfgRegularize_h52656aab_0_1) 
                                   ...
                                   : 0xffffffffU))),32);
    bufp->chgIData(oldp+157,(((IData)(vlSelfRef.top__DOT____VdfgRegularize_he2b63832_0_0)
                               ...
                               : ((0U == (0x0000001fU 
                                  ...
                                  [(0x0000001fU & (vlSelfRef.PC_command 
                                                   >> 0x00000014U))]))),32);
    bufp->chgBit(oldp+158,(((IData)(vlSelfRef.top__DOT__IDU_0__DOT____VdfgRegularize_h52656aab_0_1) 
                            | (0x37U == (0x0000007fU 
                                         & vlSelfRef.PC_command)))));
    bufp->chgBit(oldp+159,((0x00100073U == vlSelfRef.PC_command)));
    bufp->chgIData(oldp+160,((vlSelfRef.top__DOT__EXU_0__DOT__inA 
    ...
    bufp->chgCData(oldp+170,((((IData)(vlSelfRef.top__DOT__IDU_0__DOT__isADD) 
