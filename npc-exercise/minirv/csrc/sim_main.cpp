...
void setmem(){
	...
	MEM[5]=0b00000000010000000010000010000011;//lw   r1,0(r0)
	MEM[6]=0b00000000010000000100000100000011;//lbu  r2,0(r0)
	MEM[7]=0b00000000000100000000000001110011;//ebreak
