...
void setmem(){
	...
	// MEM[ 7]=0b00010000000000000010000110100011;//sw   r3,0x100(r0)
	// MEM[ 8]=0b00010000010000000010000110100011;//sb   r3,0x104(r0)
	// MEM[ 9]=0b00010000000000000010001010000011;//lw   r5,0x100(r0)
	// MEM[10]=0b00010000010000000010001100000011;//lw   r6,0x104(r0)
	MEM[11]=0b00000000000100000000000001110011;//ebreak
