...
void VPS2___024root___eval_triggers__act(VPS2___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered[0U] = (QData)((IData)(
                                                    ((((IData)(vlSelfRef.CLK) 
                                                     ...
                                                     | ((((IData)(vlSelfRef.PS2__DOT__count) 
                                                          != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__PS2__DOT__count__1)) 
                                                         << 1U) 
                                                        | ((IData)(vlSelfRef.PS2__DOT____Vcellout__u_keycode_to_ascii__ascii) 
                                                           != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__PS2__DOT____Vcellout__u_keycode_to_ascii__ascii__1))))));
    ...
    vlSelfRef.__Vtrigprevexpr___TOP__PS2__DOT__count__1 
        = vlSelfRef.PS2__DOT__count;
...
void VPS2___024root___act_sequent__TOP__0(VPS2___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPS2___024root___act_sequent__TOP__0\n"); );
    VPS2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    __Vtableidx7 = 0;
    // Body
    vlSelfRef.PS2__DOT__count = (0x000000ffU & ((IData)(1U) 
                                                + (IData)(vlSelfRef.PS2__DOT__count)));
...
void VPS2___024root___act_sequent__TOP__1(VPS2___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPS2___024root___act_sequent__TOP__1\n"); );
    VPS2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    __Vtableidx2 = ((0x0000001eU & (vlSelfRef.PS2__DOT__receiveData 
                                    << 1U)) | (IData)(vlSelfRef.PS2__DOT__displayEnable));
    ...
    __Vtableidx3 = ((0x0000001eU & (vlSelfRef.PS2__DOT__receiveData 
                                    >> 3U)) | (IData)(vlSelfRef.PS2__DOT__displayEnable));
    ...
    __Vtableidx4 = ((0x0000001eU & (vlSelfRef.PS2__DOT__receiveData 
                                    >> 7U)) | (IData)(vlSelfRef.PS2__DOT__displayEnable));
    ...
    __Vtableidx5 = ((0x0000001eU & (vlSelfRef.PS2__DOT__receiveData 
                                    >> 0x0000000bU)) 
                    | (IData)(vlSelfRef.PS2__DOT__displayEnable));
...
void VPS2___024root___eval_act(VPS2___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VactTriggered[0U])) {
        VPS2___024root___act_sequent__TOP__0(vlSelf);
        vlSelfRef.__Vm_traceActivity[1U] = 1U;
    }
    if ((1ULL & vlSelfRef.__VactTriggered[0U])) {
        VPS2___024root___act_sequent__TOP__1(vlSelf);
...
void VPS2___024root___nba_sequent__TOP__0(VPS2___024root* vlSelf) {
    ...
    CData/*4:0*/ __Vtableidx5;
    __Vtableidx5 = 0;
    IData/*23:0*/ __Vdly__PS2__DOT__receiveData;
    __Vdly__PS2__DOT__receiveData = 0;
    IData/*23:0*/ __VdlyMask__PS2__DOT__receiveData;
    __VdlyMask__PS2__DOT__receiveData = 0;
    CData/*0:0*/ __Vdly__PS2__DOT__nextdata_n;
    __Vdly__PS2__DOT__nextdata_n = 0;
    ...
    __Vdly__PS2__DOT__nextdata_n = vlSelfRef.PS2__DOT__nextdata_n;
    ...
    if (vlSelfRef.CLRN) {
        if (vlSelfRef.PS2__DOT__nextdata_n) {
            if (vlSelfRef.PS2__DOT__ready) {
                __Vdly__PS2__DOT__receiveData = ((0x00ffff00U 
                                                  & __Vdly__PS2__DOT__receiveData) 
                                                 | (IData)(vlSelfRef.data));
                __VdlyMask__PS2__DOT__receiveData = 
                    (0x000000ffU | __VdlyMask__PS2__DOT__receiveData);
                __Vdly__PS2__DOT__nextdata_n = 0U;
            }
        } else {
            __Vdly__PS2__DOT__nextdata_n = 1U;
        }
        if (vlSelfRef.PS2__DOT__ready) {
    ...
    vlSelfRef.PS2__DOT__receiveData = ((__Vdly__PS2__DOT__receiveData 
                                        & __VdlyMask__PS2__DOT__receiveData) 
                                       | (vlSelfRef.PS2__DOT__receiveData 
                                          & (~ __VdlyMask__PS2__DOT__receiveData)));
    __VdlyMask__PS2__DOT__receiveData = 0U;
    vlSelfRef.PS2__DOT__nextdata_n = __Vdly__PS2__DOT__nextdata_n;
    ...
    if (vlSelfRef.PS2__DOT__status) {
        vlSelfRef.PS2__DOT__displayEnable = 0U;
    } else if (((~ (IData)(vlSelfRef.PS2__DOT__status)) 
                & (IData)(vlSelfRef.PS2__DOT__ready))) {
        vlSelfRef.PS2__DOT__displayEnable = 1U;
    }
    __Vtableidx2 = ((0x0000001eU & (vlSelfRef.PS2__DOT__receiveData 
                                    << 1U)) | (IData)(vlSelfRef.PS2__DOT__displayEnable));
    vlSelfRef.PS2__DOT____Vcellout__segdec0____pinNumber2 
...
bool VPS2___024root___eval_phase__act(VPS2___024root* vlSelf) {
    ...
    __VactExecute = VPS2___024root___trigger_anySet__act(vlSelfRef.__VactTriggered);
    if (__VactExecute) {
