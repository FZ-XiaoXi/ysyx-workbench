...
VL_ATTR_COLD void VPS2___024root__trace_init_sub__TOP__0(VPS2___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+5,0,"displayEnable",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+5,0,"ifPressed",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+6,0,"ascii",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
...
VL_ATTR_COLD void VPS2___024root__trace_full_0_sub_0(VPS2___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+5,(vlSelfRef.PS2__DOT__ifPressed));
    bufp->fullCData(oldp+6,(vlSelfRef.PS2__DOT__ascii),8);
    bufp->fullCData(oldp+7,(vlSelfRef.PS2__DOT__count),8);
    bufp->fullBit(oldp+8,(vlSelfRef.PS2__DOT__status));
    bufp->fullBit(oldp+9,(((~ (IData)(vlSelfRef.PS2__DOT__status)) 
                           & (0xf0U == (0x000000ffU 
    ...
    bufp->fullCData(oldp+28,((0x0000000fU & (vlSelfRef.PS2__DOT__receiveData 
                                             >> 8U))),4);
    bufp->fullCData(oldp+29,(vlSelfRef.PS2__DOT____Vcellout__segdec2____pinNumber2),7);
    bufp->fullCData(oldp+30,((0x0000000fU & (vlSelfRef.PS2__DOT__receiveData 
                                             >> 0x0000000cU))),4);
