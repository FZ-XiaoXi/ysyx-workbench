...
VL_ATTR_COLD void VPS2___024root___eval_static(VPS2___024root* vlSelf) {
    ...
    vlSelfRef.__Vtrigprevexpr___TOP__PS2__DOT__count__0 
...
VL_ATTR_COLD void VPS2___024root___eval_triggers__stl(VPS2___024root* vlSelf) {
    ...
    vlSelfRef.__VstlTriggered[0U] = (QData)((IData)(
                                                    ((((IData)(vlSelfRef.PS2__DOT__count) 
                                                       != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__PS2__DOT__count__0)) 
                                                      << 1U) 
...
VL_ATTR_COLD void VPS2___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 2> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)((triggers[0U] >> 1U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 1 is active: @([hybrid] PS2.count)\n");
    }
...
VL_ATTR_COLD void VPS2___024root___stl_sequent__TOP__2(VPS2___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPS2___024root___stl_sequent__TOP__2\n"); );
    VPS2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VPS2___024root___stl_comb__TOP__1(VPS2___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPS2___024root___stl_comb__TOP__1\n"); );
    VPS2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
VL_ATTR_COLD void VPS2___024root___eval_stl(VPS2___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered[0U])) {
        VPS2___024root___stl_sequent__TOP__2(vlSelf);
        VPS2___024root____Vm_traceActivitySetAll(vlSelf);
    }
    ...
    if ((1ULL & (vlSelfRef.__VstlTriggered[1U] | vlSelfRef.__VstlTriggered
                 [0U]))) {
        VPS2___024root___stl_comb__TOP__1(vlSelf);
        VPS2___024root____Vm_traceActivitySetAll(vlSelf);
    }
}
...
VL_ATTR_COLD void VPS2___024root___ctor_var_reset(VPS2___024root* vlSelf) {
    ...
    vlSelf->PS2__DOT__displayEnable = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7245088149757860452ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__PS2__DOT__count__0 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 5544129730689144621ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__PS2__DOT__count__1 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 11644782450665607596ull);
