    ...
    , TOP__ysyxSoCFull__asic__luart__muart__Uregs{this, Verilated::catName(namep, "ysyxSoCFull.asic.luart.muart.Uregs")}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        ...
        __Vscope_ysyxSoCFull__asic__cpu__cpu__IDU_0.varInsert(__Vfinal,"isLOAD", &(TOP__ysyxSoCFull__asic__cpu__cpu__IDU_0.isLOAD), false, VLVT_UINT8,VLVD_OUT|VLVF_PUB_RW,0,0);
        __Vscope_ysyxSoCFull__asic__cpu__cpu__IDU_0.varInsert(__Vfinal,"isPC", &(TOP__ysyxSoCFull__asic__cpu__cpu__IDU_0.isPC), false, VLVT_UINT8,VLVD_OUT|VLVF_PUB_RW,0,0);
        __Vscope_ysyxSoCFull__asic__cpu__cpu__IDU_0.varInsert(__Vfinal,"isSTORE", &(TOP__ysyxSoCFull__asic__cpu__cpu__IDU_0.isSTORE), false, VLVT_UINT8,VLVD_OUT|VLVF_PUB_RW,0,0);
        __Vscope_ysyxSoCFull__asic__cpu__cpu__IDU_0.varInsert(__Vfinal,"isWRITE", &(TOP__ysyxSoCFull__asic__cpu__cpu__IDU_0.isWRITE), false, VLVT_UINT8,VLVD_OUT|VLVF_PUB_RW,0,0);
        ...
        __Vscope_ysyxSoCFull__asic__cpu__cpu__IFU_0.varInsert(__Vfinal,"in_reqValid", &(TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.in_reqValid), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0,0);
