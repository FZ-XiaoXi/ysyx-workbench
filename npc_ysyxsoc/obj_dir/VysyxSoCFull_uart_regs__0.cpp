...
void VysyxSoCFull_uart_regs___nba_sequent__TOP__ysyxSoCFull__asic__luart__muart__Uregs__1(VysyxSoCFull_uart_regs* vlSelf) {
    ...
    if (vlSymsp->TOP.reset) {
        ...
        __Vdly__msr = ((0x0fU & (IData)(__Vdly__msr)) 
                       | ((((2U & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_33) 
                                   << 1U)) | (1U & 
                                              ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_33) 
                                               >> 1U))) 
                           << 6U) | (((2U & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_33) 
                                             >> 1U)) 
                                      | (1U & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_33) 
                                               >> 3U))) 
                                     << 4U)));
