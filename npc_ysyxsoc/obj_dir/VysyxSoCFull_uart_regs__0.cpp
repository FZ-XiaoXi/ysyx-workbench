...
void VysyxSoCFull_uart_regs___nba_sequent__TOP__ysyxSoCFull__asic__luart__muart__Uregs__0(VysyxSoCFull_uart_regs* vlSelf) {
    ...
    // Body
    vlSelfRef.__VdlySet__receiver__DOT__fifo_rx__DOT__rfifo__DOT__ram__v0 = 0U;
    ...
    if (vlSelfRef.__PVT__receiver__DOT__fifo_rx__DOT__rfifo__DOT__we) {
        vlSelfRef.__VdlyVal__receiver__DOT__fifo_rx__DOT__rfifo__DOT__ram__v0 
            = (0x000000ffU & ((IData)(vlSelfRef.__PVT__receiver__DOT__rf_data_in) 
                              >> 3U));
        vlSelfRef.__VdlyDim0__receiver__DOT__fifo_rx__DOT__rfifo__DOT__ram__v0 
            = vlSelfRef.__PVT__receiver__DOT__fifo_rx__DOT__top;
        vlSelfRef.__VdlySet__receiver__DOT__fifo_rx__DOT__rfifo__DOT__ram__v0 = 1U;
    }
...
void VysyxSoCFull_uart_regs___nba_sequent__TOP__ysyxSoCFull__asic__luart__muart__Uregs__1(VysyxSoCFull_uart_regs* vlSelf) {
    ...
    if (vlSymsp->TOP.reset) {
        ...
        __Vdly__msr = ((0x0fU & (IData)(__Vdly__msr)) 
                       | ((((2U & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_31) 
                                   << 1U)) | (1U & 
                                              ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_31) 
                                               >> 1U))) 
                           << 6U) | (((2U & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_31) 
                                             >> 1U)) 
                                      | (1U & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_31) 
                                               >> 3U))) 
                                     << 4U)));
    ...
    if ((0x00000010U & (IData)(vlSelfRef.__PVT__mcr))) {
        ...
        vlSelfRef.__VdfgRegularize_h6e95ff9d_0_31 = 8U;
...
void VysyxSoCFull_uart_regs___nba_sequent__TOP__ysyxSoCFull__asic__luart__muart__Uregs__2(VysyxSoCFull_uart_regs* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (vlSelfRef.__VdlySet__receiver__DOT__fifo_rx__DOT__rfifo__DOT__ram__v0) {
        vlSelfRef.__PVT__receiver__DOT__fifo_rx__DOT__rfifo__DOT__ram[vlSelfRef.__VdlyDim0__receiver__DOT__fifo_rx__DOT__rfifo__DOT__ram__v0] 
            = vlSelfRef.__VdlyVal__receiver__DOT__fifo_rx__DOT__rfifo__DOT__ram__v0;
    }
}
