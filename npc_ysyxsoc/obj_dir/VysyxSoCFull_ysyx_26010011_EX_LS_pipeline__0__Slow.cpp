...
VL_ATTR_COLD void VysyxSoCFull_ysyx_26010011_EX_LS_pipeline___ctor_var_reset(VysyxSoCFull_ysyx_26010011_EX_LS_pipeline* vlSelf) {
    ...
    vlSelf->__PVT__exu_out_bus_isECALL = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14743238592669895264ull);
    vlSelf->__PVT__exu_out_bus_isMRET = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13519473832360846240ull);
    ...
    vlSelf->__PVT__lsu_in_bus_isECALL = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9352941159189901255ull);
    vlSelf->__PVT__lsu_in_bus_isMRET = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17550804286849070626ull);
    ...
    vlSelf->__Vdly__lsu_in_bus_isECALL = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11055384865525321045ull);
    vlSelf->__Vdly__lsu_in_bus_isMRET = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11025306135380985225ull);
