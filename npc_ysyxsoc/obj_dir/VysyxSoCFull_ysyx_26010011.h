...
class alignas(VL_CACHE_LINE_BYTES) VysyxSoCFull_ysyx_26010011 final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__idu_flush_valid;
        CData/*0:0*/ flush_exception_valid;
        CData/*0:0*/ __PVT__IROM_arvalid;
        CData/*0:0*/ __PVT__IROM_arready;
        CData/*0:0*/ __PVT__IROM_rlast;
        CData/*0:0*/ __PVT__idu_in_ready;
        CData/*0:0*/ __PVT__idu_out_valid;
        CData/*0:0*/ __PVT__idu_out_bus_isLOAD;
        CData/*0:0*/ __PVT__idu_out_bus_isSTORE;
    };
    struct {
        CData/*0:0*/ __PVT__idu_out_bus_isBRANCH;
        CData/*0:0*/ __PVT__idu_out_bus_comp_isUseImm;
        CData/*2:0*/ __PVT__idu_out_bus_opCSR;
        CData/*4:0*/ __PVT__idu_out_bus_exception;
        CData/*0:0*/ __PVT__exu_in_ready;
        CData/*0:0*/ __PVT__exu_out_bus_comp_result;
        CData/*0:0*/ __PVT__exu_out_bus_dnpc_valid;
        CData/*4:0*/ __PVT__exu_out_bus_exception;
        CData/*0:0*/ __PVT__lsu_in_ready;
        CData/*0:0*/ __PVT__DRAM_arvalid;
        CData/*0:0*/ __PVT__DRAM_arready;
        CData/*0:0*/ __PVT__DRAM_rready;
        CData/*2:0*/ __PVT__DRAM_arsize;
        CData/*4:0*/ __PVT__lsu_out_bus_exception;
        CData/*0:0*/ __PVT__fencei_pass;
        CData/*4:0*/ __PVT__wbu_out_bus_exception;
    ...
    struct {
        ...
        CData/*0:0*/ IDU_0__DOT____VdfgRegularize_hd1728725_0_30;
        ...
        IData/*31:0*/ __PVT__dnpc;
        IData/*31:0*/ __PVT__idu_out_bus_imm;
        IData/*31:0*/ __PVT__idu_out_bus_csr;
        IData/*31:0*/ __PVT__exu_out_bus_alu_result;
        IData/*31:0*/ __PVT__lsu_out_bus_lsu_result;
        IData/*31:0*/ tb_FINAL_pc;
        IData/*31:0*/ tb_FINAL_npc;
        IData/*31:0*/ tb_alu_result;
        IData/*31:0*/ tb_FINAL_inst;
        IData/*31:0*/ __PVT__gpr_rdataa;
        IData/*31:0*/ __PVT__gpr_rdatab;
        IData/*31:0*/ __PVT__csr_rdata;
        IData/*31:0*/ __PVT__r_tar;
        ...
        VlUnpacked<CData/*0:0*/, 8> __PVT__bcache_u0__DOT__cache_type;
    };
