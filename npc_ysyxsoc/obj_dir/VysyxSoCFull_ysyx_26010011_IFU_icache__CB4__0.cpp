...
void VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___ico_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__0(VysyxSoCFull_ysyx_26010011_IFU_icache__CB4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___ico_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__0\n"); );
    VysyxSoCFull__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__in_reqValid = ((~ (((0U != (3U 
                                                 & vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.PC))
                                          ? 0x10U : 0U) 
                                        >> 4U)) & (IData)(vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.__PVT__in_reqValid));
...
void VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___ico_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__1(VysyxSoCFull_ysyx_26010011_IFU_icache__CB4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___ico_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__1\n"); );
    VysyxSoCFull__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
void VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___ico_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__2(VysyxSoCFull_ysyx_26010011_IFU_icache__CB4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___ico_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__2\n"); );
    VysyxSoCFull__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
extern const VlUnpacked<CData/*0:0*/, 128> VysyxSoCFull__ConstPool__TABLE_h75e0d3b0_0;
...
void VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___nba_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__0(VysyxSoCFull_ysyx_26010011_IFU_icache__CB4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___nba_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__0\n"); );
    VysyxSoCFull__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    IData/*27:0*/ __VdlyVal__cache_tag__v4;
    __VdlyVal__cache_tag__v4 = 0;
    CData/*1:0*/ __VdlyDim0__cache_tag__v4;
    __VdlyDim0__cache_tag__v4 = 0;
    CData/*0:0*/ __VdlySet__cache_tag__v4;
    __VdlySet__cache_tag__v4 = 0;
    CData/*0:0*/ __VdlySet__cache_mem__v0;
    __VdlySet__cache_mem__v0 = 0;
    IData/*31:0*/ __VdlyVal__cache_mem__v4;
    __VdlyVal__cache_mem__v4 = 0;
    CData/*4:0*/ __VdlyLsb__cache_mem__v4;
    __VdlyLsb__cache_mem__v4 = 0;
    CData/*1:0*/ __VdlyDim0__cache_mem__v4;
    __VdlyDim0__cache_mem__v4 = 0;
    CData/*0:0*/ __VdlySet__cache_mem__v4;
    __VdlySet__cache_mem__v4 = 0;
    // Body
    __Vdly__burst_cnt = vlSelfRef.__PVT__burst_cnt;
    __VdlySet__cache_mem__v0 = 0U;
    __VdlySet__cache_mem__v4 = 0U;
    __VdlySet__cache_tag__v0 = 0U;
    __VdlySet__cache_tag__v4 = 0U;
    ...
    if (vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu.reset) {
        ...
        if ((((IData)(vlSelfRef.__PVT__r_fire) & (2U 
             ...
             & (~ (IData)(vlSelfRef.pc_flush)))) {
            __VdlyVal__cache_mem__v4 = vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.rdata;
            __VdlyLsb__cache_mem__v4 = (0x0000001fU 
                                        & VL_SHIFTL_III(5,32,32, (IData)(vlSelfRef.__PVT__burst_cnt), 5U));
            __VdlyDim0__cache_mem__v4 = (3U & (vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.PC 
                                               >> 2U));
            __VdlySet__cache_mem__v4 = 1U;
            __VdlyVal__cache_tag__v4 = (vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.PC 
                                        >> 4U);
            __VdlyDim0__cache_tag__v4 = (3U & (vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0.PC 
                                               >> 2U));
            __VdlySet__cache_tag__v4 = 1U;
    ...
    __Vdly__burst_cnt = VysyxSoCFull__ConstPool__TABLE_h75e0d3b0_0
        [__Vtableidx1];
    vlSelfRef.__PVT__burst_cnt = __Vdly__burst_cnt;
    if (__VdlySet__cache_mem__v0) {
        vlSelfRef.__PVT__cache_mem[0U] = 0U;
        vlSelfRef.__PVT__cache_mem[1U] = 0U;
        vlSelfRef.__PVT__cache_mem[2U] = 0U;
        vlSelfRef.__PVT__cache_mem[3U] = 0U;
    }
    if (__VdlySet__cache_mem__v4) {
        vlSelfRef.__PVT__cache_mem[__VdlyDim0__cache_mem__v4] 
            = (((~ ((IData)(0xffffffffU) << (IData)(__VdlyLsb__cache_mem__v4))) 
                & vlSelfRef.__PVT__cache_mem[__VdlyDim0__cache_mem__v4]) 
               | (0x00000000ffffffffULL & (__VdlyVal__cache_mem__v4 
                                           << (IData)(__VdlyLsb__cache_mem__v4))));
    }
    ...
    if (__VdlySet__cache_tag__v4) {
        vlSelfRef.__PVT__cache_tag[__VdlyDim0__cache_tag__v4] 
            = __VdlyVal__cache_tag__v4;
    }
...
void VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___nba_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__1(VysyxSoCFull_ysyx_26010011_IFU_icache__CB4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___nba_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__1\n"); );
    VysyxSoCFull__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__in_reqValid = ((~ (((0U != (3U 
...
void VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___nba_comb__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__0(VysyxSoCFull_ysyx_26010011_IFU_icache__CB4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VysyxSoCFull_ysyx_26010011_IFU_icache__CB4___nba_comb__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0__0\n"); );
    VysyxSoCFull__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__r_fire = ((~ (IData)(vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu.reset)) 
