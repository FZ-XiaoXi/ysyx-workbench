...
VL_ATTR_COLD void VysyxSoCFull_ysyx_26010011_IF_ID_pipeline___ctor_var_reset(VysyxSoCFull_ysyx_26010011_IF_ID_pipeline* vlSelf) {
    ...
    vlSelf->__Vdly__idu_in_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3546421253727989433ull);
    ...
    vlSelf->__Vdly__idu_in_bus_exception = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 11075674475090807948ull);
}
