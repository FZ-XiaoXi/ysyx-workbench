...
VL_ATTR_COLD void VysyxSoCFull_ysyx_26010011_IFU_icache___eval_static__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0(VysyxSoCFull_ysyx_26010011_IFU_icache* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VysyxSoCFull_ysyx_26010011_IFU_icache___eval_static__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0\n"); );
...
VL_ATTR_COLD void VysyxSoCFull_ysyx_26010011_IFU_icache___ctor_var_reset(VysyxSoCFull_ysyx_26010011_IFU_icache* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VysyxSoCFull_ysyx_26010011_IFU_icache___ctor_var_reset\n"); );
    VysyxSoCFull__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__cache_mem[__Vi0] = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16322108757504633651ull);
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
