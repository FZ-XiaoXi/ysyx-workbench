...
VL_ATTR_COLD void VysyxSoCFull_ysyx_26010011_IFU_icache___eval_static__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0(VysyxSoCFull_ysyx_26010011_IFU_icache* vlSelf);
...
VL_ATTR_COLD void VysyxSoCFull___024root___eval_static(VysyxSoCFull___024root* vlSelf) {
    ...
    VysyxSoCFull_ysyx_26010011_IFU_icache___eval_static__TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0((&vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__IFU_0__icache_u0));
...
VL_ATTR_COLD void VysyxSoCFull_ysyx_26010011_ID_EX_pipeline___stl_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__ID_EX_inst__0(VysyxSoCFull_ysyx_26010011_ID_EX_pipeline* vlSelf);
...
VL_ATTR_COLD void VysyxSoCFull___024root___eval_stl(VysyxSoCFull___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered[0U])) {
        ...
        VysyxSoCFull_ysyx_26010011_GPRs___stl_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__GPR_0__0((&vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__GPR_0));
        VysyxSoCFull_ysyx_26010011_ID_EX_pipeline___stl_sequent__TOP__ysyxSoCFull__asic__cpu__cpu__ID_EX_inst__0((&vlSymsp->TOP__ysyxSoCFull__asic__cpu__cpu__ID_EX_inst));
...
VL_ATTR_COLD void VysyxSoCFull___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)((triggers[0U] >> 0x0000000bU)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 11 is active: @(posedge ysyxSoCFull.asic.cpu.cpu.reset)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VysyxSoCFull___024root___ctor_var_reset(VysyxSoCFull___024root* vlSelf) {
    ...
    vlSelf->__Vtrigprevexpr___TOP__ysyxSoCFull__asic__cpu__cpu__reset__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7997225568551083034ull);
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
