...
#ifndef VERILATED_VYSYXSOCFULL_YSYX_26010011_IFU_ICACHE__CB4_H_
#define VERILATED_VYSYXSOCFULL_YSYX_26010011_IFU_ICACHE__CB4_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VysyxSoCFull_ysyx_26010011_IFU_icache__CB4 final : public VerilatedModule {
  public:
    ...
    VlUnpacked<IData/*31:0*/, 4> __PVT__cache_mem;
    VlUnpacked<CData/*0:0*/, 4> __PVT__cache_valid;
    VlUnpacked<IData/*27:0*/, 4> __PVT__cache_tag;

    // INTERNAL VARIABLES
    VysyxSoCFull__Syms* const vlSymsp;

    // CONSTRUCTORS
    VysyxSoCFull_ysyx_26010011_IFU_icache__CB4(VysyxSoCFull__Syms* symsp, const char* v__name);
    ~VysyxSoCFull_ysyx_26010011_IFU_icache__CB4();
    VL_UNCOPYABLE(VysyxSoCFull_ysyx_26010011_IFU_icache__CB4);
